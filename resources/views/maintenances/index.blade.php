...
@section('content')
    <div class="flex flex-col gap-4">
        ...
        <ul class="flex items-center gap-2 md:grid-cols-2">
            <li>
                <input onchange="loadVehicleDataForMaintenance()" type="radio" id="all" name="vehicleStatusFilter"
                    value="" class="hidden peer" required="" checked="">
                <label for="all"
            ...
            @foreach ($vehicleStatuses as $vehicleStatus)
                <li>
                    <input onchange="loadVehicleDataForMaintenance()" type="radio" id="{{ $vehicleStatus->id }}"
