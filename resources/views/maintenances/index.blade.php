...
<div class="flex flex-col gap-4">
    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">MAINTENANCE</h1>
    <div class="flex items-center gap-4 justify-between">
        <input type="text" onchange="loadVehicleDataForMaintenance()" name="vehicleSearch" id="vehicleSearch"
    ...
    <ul class="flex items-center gap-2 md:grid-cols-2">
        <li>
            <input onchange="loadVehicleDataForMaintenance()" type="radio" id="all" name="vehicleStatusFilter" value=""
        ...
        <li>
            <input onchange="loadVehicleDataForMaintenance()" type="radio" id="{{ $vehicleStatus->id }}" name="vehicleStatusFilter" value="{{ $vehicleStatus->id }}"
                class="hidden peer">
