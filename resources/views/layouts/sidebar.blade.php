        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ url('/') }}" class="flex ms-2 md:me-24">
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">COAL
                        HAULING COMPANY</span>
                </a>
            </div>
                ...
                <div class="flex items-center ms-3">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        <ul class="py-1" role="none">
                            <li>
                                <button onclick="showFlowBytesModal('change-password-modal')"
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            @endmoduleAction
            @moduleAction('Vehicle Report', 'Read')
                <li>
            ...
            @moduleAction('Maintenance', 'Read')
                <li>
                    <a href="{{ url('maintenances') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Maintenances</span>
                    </a>
                </li>
            @endmoduleAction
            @moduleAction('Sparepart', 'Read')
                <li>
