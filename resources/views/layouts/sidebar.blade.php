        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ url('/') }}" class="flex ms-2 md:me-24">
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">COAL HAULING COMPANY</span>
                </a>
            </div>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ url('/branch') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Branches</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ url('/tax-configuration') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Tax Configurations</span>
                </a>
            </li>

            <li>
                <a href="{{ url('/pos-configuration') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 20 20">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">POS Configurations</span>
                </a>
            </li>
